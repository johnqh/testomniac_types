...
**npm**: `@sudobility/entitytestomniac_types` (public)
...
```
@sudobility/entitytestomniac_types (this package)
    ^
entitytestomniac_api
entitytestomniac_client
entitytestomniac_lib
entitytestomniac_app
entityentitytestomniac_app_rn
```
...
- **entitytestomniac_api** — Backend API server (Hono + PostgreSQL); imports types for request/response validation
- **entitytestomniac_client** — API client SDK with TanStack Query hooks; imports types for API contracts
- **entitytestomniac_lib** — Business logic library with Zustand stores; imports types transitively via entitytestomniac_client
- **entitytestomniac_app** — Web application (React + Vite); imports types transitively via entitytestomniac_client and entitytestomniac_lib
- **entityentitytestomniac_app_rn** — React Native mobile app (Expo); imports types via file: links

All other testomniac_* projects depend on this package. This package depends on `@sudobility/types` for base infrastructure types (`BaseResponse`, `NetworkClient`, etc.).
...
- Changes here affect ALL consumer projects (entitytestomniac_api, entitytestomniac_client, entitytestomniac_lib, entitytestomniac_app, entityentitytestomniac_app_rn) -- always consider downstream impact
